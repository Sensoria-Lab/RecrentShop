    ...
    <div className="relative flex flex-col gap-4">
      <div className="flex items-center gap-4">
        ...
        <button
          onClick={handlePrev}
          disabled={!canGoPrev}
          className={`flex-shrink-0 p-3 transition-all duration-200 z-10 border ${
            canGoPrev 
              ? 'bg-[#EAE2E6]/[0.07] hover:bg-[#EAE2E6]/[0.14] border-[#EAE2E6]/12 hover:border-[#EAE2E6]/25 text-[#EAE2E6]/60 hover:text-[#EAE2E6] cursor-pointer' 
              : 'bg-[#EAE2E6]/[0.03] border-[#EAE2E6]/[0.05] text-[#EAE2E6]/20 cursor-not-allowed'
          }`}
          aria-label="Previous"
        >
      ...
      {totalItems > responsiveItemsPerView && (
        <div className="flex justify-center w-full py-2">
          <div 
            ...
            className="relative w-48 h-[3px] bg-[#EAE2E6]/10 overflow-hidden cursor-pointer"
          ...
          >
            ...
            <div
              ref={scrollbarRef}
              className="absolute top-0 left-0 h-full bg-[#EAE2E6]/70 cursor-grab active:cursor-grabbing transition-opacity hover:bg-[#EAE2E6]"
              style={{
                width: `${indicatorWidth}%`,
                left: `${indicatorPosition}%`,
                transition: (isDraggingScrollbar || isDragging || Math.abs(dragOffset) > 0)
                  ? 'none' 
                  : 'left 0.4s cubic-bezier(0.25, 0.1, 0.25, 1), width 0.3s ease'
              }}
            >
              {/* Shine effect */}
              <div className="absolute inset-0 bg-gradient-to-r from-transparent via-[#EAE2E6]/30 to-transparent opacity-70" />
            </div>
          </div>
        </div>
      )}
