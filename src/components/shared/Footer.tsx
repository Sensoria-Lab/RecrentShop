...
import { SOCIAL_LINKS, SITE_CONFIG, COMPANY_INFO } from '../../constants/config';
                ...
                <div className="pt-1">
                  ...
                  <div className="flex flex-wrap items-center gap-1.5">
                    <a
                      ...
                      aria-label="Twitch"
                    >
                      <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor" className="text-white/40 group-hover:text-purple-400 transition-colors">
                    ...
                    <a
                      ...
                      aria-label="Telegram"
                    >
                      <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor" className="text-white/40 group-hover:text-blue-400 transition-colors">
                    ...
                    <a
                      ...
                      aria-label="YouTube"
                    >
                      <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor" className="text-white/40 group-hover:text-red-500 transition-colors">
                    ...
                    >
                      <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor" className="text-white/40 group-hover:text-blue-500 transition-colors">
                    ...
                    <a
                      ...
                      aria-label="Discord"
                    >
                      <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor" className="text-white/40 group-hover:text-indigo-400 transition-colors">
                    ...
                    <a
                      ...
                      aria-label="TikTok"
                    >
                      <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor" className="text-white/40 group-hover:text-gray-300 transition-colors">
