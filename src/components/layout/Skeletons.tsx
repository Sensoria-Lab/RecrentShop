  ...
  return (
    <>
      {Array.from({ length: count }).map((_, index) => (
        ...
        >
          {/* Image skeleton */}
          <div className="aspect-[4/5] bg-[#EAE2E6]/[0.06] relative overflow-hidden">
            {/* Shimmer effect */}
          ...
          <div className="mt-3 space-y-2">
            <div className="h-4 bg-[#EAE2E6]/[0.06] w-3/4" />
            <div className="h-3 bg-[#EAE2E6]/[0.06] w-1/2" />
            <div className="h-5 bg-[#EAE2E6]/[0.06] w-2/3 mt-3" />
          </div>
        </div>
      ))}
    </>
  ...
  return (
    <>
      {Array.from({ length: count }).map((_, index) => (
        <div
          key={index}
          className="bg-[#EAE2E6]/[0.04] border border-[#EAE2E6]/[0.07] p-3 animate-pulse"
          style={{
        ...
        >
          <div className="flex gap-3">
            {/* Image */}
            <div className="w-16 h-16 bg-[#EAE2E6]/[0.06] flex-shrink-0" />
